...
If you're new to OAuth I'd recommend to have a look at the "official docs":http://oauth.net and "the last video on using OAuth with Android (which says it's basically impossible in 2011)":http://www.youtube.com/watch?v=9fBcrzA-hWY 
